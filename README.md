...
| **Batch Tagging (`zotero_batch_tag.js`)** | Add, remove, or replace tags for selected Zotero items. | [README](https://github.com/thalient-ai/zotero-scripts/tree/main/zotero-batch-tag) | [Script](https://github.com/thalient-ai/zotero-scripts/blob/main/zotero-batch-tag/src/zotero_batch_tag.js) |
