...
| **Bulk Edit (`zotero_bulk_edit.js`)** | Edit the metadata (fields, notes, and authors) for multiple items. | [README](https://github.com/thalient-ai/zotero-scripts/tree/main/zotero-bulk-edit) | [Script](https://github.com/thalient-ai/zotero-scripts/blob/main/zotero-bulk-edit/src/zotero_bulk_edit.js) |
